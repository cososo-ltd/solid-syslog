 ...
 */
#define SOLIDSYSLOG_CAT_RESOLVER_BASE 0x0200U
#define SOLIDSYSLOG_CAT_TLSSTREAM_BASE 0x0400U
#define SOLIDSYSLOG_CAT_SECURITYPOLICY_BASE 0x0500U
#define SOLIDSYSLOG_CAT_BUFFER_BASE 0x0600U
