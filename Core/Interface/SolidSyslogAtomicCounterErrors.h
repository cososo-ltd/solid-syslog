...
/** @file
 *  Portable detail codes for the AtomicCounter role, shared by every backend that fills it. */
#ifndef SOLIDSYSLOGATOMICCOUNTERERRORS_H
#define SOLIDSYSLOGATOMICCOUNTERERRORS_H

#include "SolidSyslogExternC.h"

SOLIDSYSLOG_EXTERN_C_BEGIN

    /** Detail codes a AtomicCounter role implementation reports through
    ...
    enum SolidSyslogAtomicCounterErrors
    {
        ...
        SOLIDSYSLOG_ATOMIC_COUNTER_ERROR_MAX /**< One past the last code; never emitted. Bounds the range for iteration. */
    };

SOLIDSYSLOG_EXTERN_C_END

#endif /* SOLIDSYSLOGATOMICCOUNTERERRORS_H */
