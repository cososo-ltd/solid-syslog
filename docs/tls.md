...
### Accept a peer authorized by certificate fingerprint

RFC 5425 §5.1 requires that a peer can be authorized by its certificate
...
Fingerprint-based peer authorization is the fourth, and differs from the others:
neither platform falls short of it, because neither offers it at all. Until
[#753](https://github.com/cososo-ltd/solid-syslog/issues/753) lands, a peer is
authorized by trust anchor and name.
