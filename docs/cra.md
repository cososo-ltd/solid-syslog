...
| **(7)** | securely distribute updates | [Release verification](security/release-verification.md): a signed source-tree hash and signed CycloneDX SBOM, both verifiable against the workflow and tag that produced them |
