...
This is the maintainer's operational counterpart to [`SECURITY.md`](policy.md):
...
as supporting evidence for [CRA](../cra.md) diligence: protect the release tags and `main`,
