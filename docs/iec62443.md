...
verification, endpoint identity, mutual TLS, revocation — is stated once under
[TLS obligations](tls.md), and each backend's page records where it falls short of
that today. Both controls have requirement enhancements calling for
