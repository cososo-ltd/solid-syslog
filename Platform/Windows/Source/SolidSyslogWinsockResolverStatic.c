...
static size_t WinsockResolver_IndexFromHandle(const struct SolidSyslogResolver* base);
static void WinsockResolver_CleanupAtIndex(size_t index, void* context);
