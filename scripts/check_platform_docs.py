...
if __name__ == "__main__":
    ...
    print(
        f"docs match the code: {len(registered())} platforms, all documented and none naming "
        f"another; {len(declared_roles())} roles, each listed everywhere roles are enumerated"
    )
