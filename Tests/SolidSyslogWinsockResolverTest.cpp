...
TEST(SolidSyslogWinsockResolverPool, ExhaustedCreateReportsError)
{
    ...
    UNSIGNED_LONGS_EQUAL(SOLIDSYSLOG_WINSOCK_RESOLVER_ERROR_POOL_EXHAUSTED, ErrorHandlerFake_LastDetail());
}
...
TEST(SolidSyslogWinsockResolverPool, DestroyOfUnknownHandleReportsWarning)
{
    ...
    UNSIGNED_LONGS_EQUAL(SOLIDSYSLOG_WINSOCK_RESOLVER_ERROR_UNKNOWN_DESTROY, ErrorHandlerFake_LastDetail());
}
